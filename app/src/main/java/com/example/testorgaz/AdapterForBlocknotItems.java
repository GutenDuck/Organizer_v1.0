...
public class AdapterForBlocknotItems extends BaseAdapter
{
    Context ctx;
    ...
    AdapterForBlocknotItems(Context context, ArrayList<BlocknotItems> product) {
        ctx = context;
        objects = product;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (view == null)
        {
            view = lInflater.inflate(R.layout.failsblocknot, parent, false);
        }
        ...
        ((TextView) view.findViewById(R.id.tvZag)).setText(p.name);
        ((TextView) view.findViewById(R.id.tvText)).setText(p.Text + "");
        ((TextView) view.findViewById(R.id.textVal)).setText(p.vali+ "");
        ((ImageView) view.findViewById(R.id.ivImage)).setImageDrawable(p.image);
        ((TextView) view.findViewById(R.id.textView2)).setText(p.tx);
